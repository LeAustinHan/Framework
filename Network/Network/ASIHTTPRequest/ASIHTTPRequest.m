...
{
	return [[ASIHTTPRequest alloc] initWithURL:newURL];
}
...
- (void)releaseBlocksOnMainThread
{
	...
	if (downloadSizeIncrementedBlock) {
		...
		self.downloadSizeIncrementedBlock = nil;
	}
	if (uploadSizeIncrementedBlock) {
		[blocks addObject:uploadSizeIncrementedBlock];
		self.uploadSizeIncrementedBlock = nil;
	}
