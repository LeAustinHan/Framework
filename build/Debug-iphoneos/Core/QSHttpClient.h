...
@private
	...
	__weak id <QSHttpClientDelegate> _objDelegate;
}

@property (nonatomic, strong, getter=url, setter=setUrl:) NSString * _strUrl;
@property (nonatomic, strong, getter=httpMethod, setter=setHttpMethod:) NSString * _strHttpMethod;
...
@property (nonatomic, strong, getter=responseData) NSData * _objResponseData;
...
@property (nonatomic, weak /* weak ref */, getter=delegate, setter=setDelegate:) id <QSHttpClientDelegate> _objDelegate;
