...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	__weak id <ASIHTTPRequestDelegate> delegate;
	...
	__weak id <ASIProgressDelegate> uploadProgressDelegate;
	...
	__weak id <ASIProgressDelegate> downloadProgressDelegate;
	...
	__weak ASIHTTPRequest *mainRequest;
	...
	__weak id <ASICacheDelegate> downloadCache;
...
@property (weak) id <ASICacheDelegate> downloadCache;
