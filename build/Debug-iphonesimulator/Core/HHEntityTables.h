 ...
 */
@interface HHEntityTables : NSObject {
...
@interface HHEntityTables (TTSingleton)

// Access the singleton instance: [[TBEntityTables sharedInstance] <methods>]
+ (HHEntityTables *)sharedInstance;
